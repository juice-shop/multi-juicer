export default {
  ...
  "admin.notification.end_date.label": "Дата завершення події (необов'язково)",
  "admin.notification.end_date.hint_future": "{time} від зараз",
  "admin.notification.end_date.hint_past": "Ця дата в минулому",
  "notification.event_ended": "Подія завершилась",
  "ctf.game_clock.title": "Ігровий годинник",
  "ctf.game_clock.ended": "Подія завершилась",
