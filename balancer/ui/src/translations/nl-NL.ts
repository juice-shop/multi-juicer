export default {
  ...
  "team_score": "Je team staat op de {position}e plaats van {totalTeams} met {solvedChallengeCount} opgeloste uitdagingen.",
  "score_display": "{score} punten",
  "solved_challenges_display": "{solved_challenge_count} opgeloste uitdagingen",
  "name": "Naam",
  "score": "Punten"
};
