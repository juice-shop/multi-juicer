export default {
    ...
    "team_score": "Ваша команда займає {position}-е місце з {totalTeams}, вирішивши {solvedChallengeCount} завдань.",
    "score_display": "{score} балів",
    "solved_challenges_display": "{solved_challenge_count} вирішених завдань",
    "name": "Ім'я",
    "score": "Бали"
};
