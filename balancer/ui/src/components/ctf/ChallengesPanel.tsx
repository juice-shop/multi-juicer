...
export function ChallengesPanel({
  ...
  if (selectedChallenge) {
    return (
      <div className="absolute top-5 right-5 bottom-5 w-87.5 bg-ctf-bg-panel border-2 border-ctf-primary backdrop-blur-[5px] flex flex-col z-100 transition-[height] duration-300 shadow-[0_0_5px_rgba(255,107,107,0.3),inset_0_0_5px_rgba(255,107,107,0.05)] max-[1024px]:w-70 max-[1024px]:right-2.5 max-[1024px]:top-2.5 max-[1024px]:bottom-2.5 max-[768px]:hidden">
