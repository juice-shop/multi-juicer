export default {
  ...
  "admin.notification.end_date.label": "Einddatum evenement (optioneel)",
  "admin.notification.end_date.hint_future": "{time} vanaf nu",
  "admin.notification.end_date.hint_past": "Deze datum ligt in het verleden",
  "notification.event_ended": "Het evenement is afgelopen",
  "ctf.game_clock.title": "Spelklok",
  "ctf.game_clock.ended": "Het evenement is afgelopen",
